              ...
              <div className="containerm">
                <div className="firstmain__left">
                  ...
                  <p
                    ...
                    data-wow-duration="2s"
                  >
                    Recommended to read on PC, and follow along on your Phone to
                    make it easier. This will take approximately 15-30 minutes
                    if you're new.
                  </p>
                </div>
              </div>
              ...
              <div className="buynow__inside">
                  ...
                  <div className="buynow__right">
                    ...
                    >
                      <p>
                        ...
                        phrase a secret! Never share it with anyone and store it
                        properly! Make sure to copy the contract address below!
                      </p>
                    </div>
                    <div
                ...
                <div className="buynow__item">
                  ...
                  <div className="buynow__right">
                    ...
                    >
                      <p>
                        Tap the icon in the top-right and search for "Safemoon".
                        If it's not there, tap "Add Custom Token".
                      </p>
                      <p>
                      ...
                      <p>
                        Click "Done" at the top and you should now have Safemoon
                ...
                <div className="buynow__item">
                  ...
                  <div className="buynow__right">
                    ...
                    >
                      <p>
                        Tap on "Smart Chain" on the main screen of trust wallet,
                        then tap "Buy" in the top right. This step may require
                        KYC verification, so have documents ready to prove your
                        identity.
                      </p>
                      <p>
                        {" "}
                ...
                <div className="buynow__item">
                  ...
                  <div className="buynow__right">
                    ...
                    >
                      <p>
                        Once your transaction has been cleared, and you have BSC
                        on your Trust Wallet, Go to DApps (or "Browser" for
                        iPhones) at the bottom of the main screen. If the
                        Browser button is not visible at the bottom for iPhone,
                        open Safari and in the URL type trust://browser_enable,
                        then return to trust wallet.
                      </p>
                      <p>
                        Open the DApps, or Browser, section and find PancakeSwap
                        and open it. Connect your Trust Wallet in the top-right.
                        Scroll down a little to the "Exchange" box
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="discl wow fadeInUp" data-wow-duration="2s">
                <div className="discl__inside">
                  ...
                  <i>
                    ...
                    cryptocurrency involves a significant amount of risk and you
                    should understand all implications involved. Prices may
                    fluctuate on any given day and due to such fluctuations you
                    may lose some or all of your investments. Due to the
                    inherent risks associated with Cryptocurrency you should
                    seek Independent legal or financial advice to understand the
